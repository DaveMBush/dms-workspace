...
2. Use the meta file to recover PR number, branch name, repo, and worktree path.
...
8. If story changes include UI, run a quick Playwright sanity validation; if they include unfamiliar API usage, run a quick Context7 check.
