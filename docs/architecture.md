...
- Frontend consumers:
  - `apps/dms/src/app/store/universe/universe-effect.service.ts`
  - `apps/dms/src/app/global/global-universe/universe-data.service.ts`
  - `apps/dms/src/app/universe-settings/*`
