...
Give the executing agent enough context to make good judgment calls — not just enough to follow steps. The right test for every piece of content is: "Would the agent make _better decisions_ with this context?" If yes, keep it. If it's genuinely redundant or mechanical, cut it.
