...
describe('Prisma Client - PostgreSQL', () => {
  ...
  describe('checkDatabaseHealth', () => {
    ...
    // TODO(E3): blocked — SQLite accepts any path; test appropriate for PostgreSQL only
  ...
  describe('connectWithRetry', () => {
    ...
    // TODO(E3): blocked — SQLite connection never fails; test appropriate for PostgreSQL only
