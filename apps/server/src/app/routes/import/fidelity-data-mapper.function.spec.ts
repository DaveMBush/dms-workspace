...
describe.skip('mapFidelityTransactions', function () {
  ...
  describe('account name matching', function () {
    ...
    test('should throw error when account not found', async function () {
      const rows: ParsedCsvRow[] = [
        {
          date: '02/15/2026',
          action: 'YOU BOUGHT',
  ...
  describe('edge cases', function () {
    ...
    test('should handle symbol not found in universe', async function () {
      const rows: ParsedCsvRow[] = [
        {
          date: '02/15/2026',
          action: 'YOU BOUGHT',
      ...
      await expect(mapFidelityTransactions(rows)).rejects.toThrow(
        'Symbol "UNKNOWN" not found in universe'
      );
    });
