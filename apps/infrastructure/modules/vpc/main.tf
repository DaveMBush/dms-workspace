...
resource "aws_route_table" "private" {
  ...
  tags = {
    Name = var.enable_nat_gateway ? "${var.project_name}-${var.environment}-private-rt-${var.availability_zones[count.index]}" : "${var.project_name}-${var.environment}-private-rt"
  }
}
