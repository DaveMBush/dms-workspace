...
resource "aws_iam_policy" "ecs_task_execution_cloudwatch" {
  name        = "${var.project_name}-${var.environment}-ecs-task-execution-cloudwatch"
...
resource "aws_iam_role_policy_attachment" "ecs_task_execution_cloudwatch" {
  role       = aws_iam_role.ecs_task_execution.name
  policy_arn = aws_iam_policy.ecs_task_execution_cloudwatch.arn
}
