...
/**
 * Create a single deletable universe symbol for isolated delete tests.
 * Unlike seedUniverseE2eData, this creates one universe row (no trades,
 * isCef: false) so the test is fully retryable — beforeAll does not re-run
 * on Playwright retries, but beforeEach does.
 */
