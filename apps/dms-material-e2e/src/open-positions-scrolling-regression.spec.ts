...
const QUANTITY_CELL_SELECTOR = '.dms-body-row[role="row"] .dms-body-cell[data-column="quantity"]';
const BUY_CELL_SELECTOR = '.dms-body-row[role="row"] .dms-body-cell[data-column="buy"]';
...
// ─── Story 101.3: Header-Invariant Regression — Open Positions ─────────────────
 ...
 */
test.describe('Open Positions — Story 101.3 slow-scroll header-invariant regression', () => {
  let cleanup: () => Promise<void>;
  let accountId: string;
