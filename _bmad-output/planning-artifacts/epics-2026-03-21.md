...
*No new NFRs - these are bug fixes addressing visual regression and UX issues from Epic 8.*
...
*No formal UX design document exists for these bug fixes - requirements are based on restoring previous functionality.*
