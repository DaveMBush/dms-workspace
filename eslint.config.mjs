  ...
  return [
    ...
    },
    {
      plugins: {
        ...
        '@angular-eslint': angularEslintEslintPlugin, // alias for rule references
    ...
    ...nxEslintPlugin.configs['flat/angular'].map((config) => ({
      ...config,
      files: ['**/*.ts'],
      ignores: ['**/playwright.config.ts', '**/test-setup.ts'],
      rules: {
    ...
    },
    {
      ...
      rules: {
        // Superseded by vitest/expect-expect below
